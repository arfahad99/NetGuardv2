...
describe('AppFooterComponent', () => {
  ...
  it('should render social links', () => {
    ...
    const expectedIcons = ['bi-github', 'bi-linkedin', 'bi-facebook', 'bi-envelope-fill'];
  ...
  it('should render contact section', () => {
    ...
    expect(sectionTitle?.textContent?.trim()).toBe('Contact');
  ...
  it('should render contact information with correct icons', () => {
    ...
    const expectedIcons = ['bi-geo-alt-fill', 'bi-telephone-fill', 'bi-envelope-fill'];
